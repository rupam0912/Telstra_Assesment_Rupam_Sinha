...
##### The POST API should substitute the {REF\_\*} values in payload using refernceData and return the transformed payload.
...
Solution by Rupam Sinha

The POST Endpoint: https://mighty-ravine-08082.herokuapp.com/test
